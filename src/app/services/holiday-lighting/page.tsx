...
export const metadata: Metadata = {
  title: "Holiday Lighting Installation in Omaha, NE",
  description:
    "Professional holiday lighting installation, maintenance, and removal in Omaha. Full-service Christmas lights with 48-hour service guarantee.",
  openGraph: {
    title: "Holiday Lighting Installation in Omaha, NE",
    description:
      "Professional holiday lighting installation in Omaha. Full-service Christmas lights with 48-hour service guarantee.",
  },
};
        ...
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 pb-16 pt-8 sm:px-6 lg:px-0">
          ...
          <section className="space-y-4">
            <FadeInSection className="space-y-3 text-center">
              <h2 className="text-5xl md:text-6xl font-black tracking-tight text-pine drop-shadow-[0_6px_18px_rgba(0,0,0,0.15)]">Holiday Lighting FAQs</h2>
