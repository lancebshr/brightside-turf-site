...
export const GET_QUOTE_BUTTON_CLASSNAME =
  "rounded-full px-8 py-5 text-lg font-semibold uppercase tracking-wide text-white transition-all duration-300 ease-out hover:scale-105 hover:brightness-110";

export const BOLD_PLUS_HEADING =
  "text-5xl md:text-6xl font-black tracking-tight text-pine drop-shadow-[0_6px_18px_rgba(0,0,0,0.15)]";
